...
- Journal Review: [IEEE TAES](https://ieee-aess.org/publications/taes), [IEEE TVT](https://vtsociety.org/publication/ieee-transactions-vehicular-technology), [IEEE/ACM TASLP](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=6570655)
- Conference Review: [ICASSP 2025](https://2025.ieeeicassp.org/)

## Technical Skills

- **Expertise**: Matrix Analysis, Optimization, Statistical & Array Signal Processing
- **Programming**: Python, MATLAB, C/C++
- **Tools**: Git, Linux/Shell, LaTeX
